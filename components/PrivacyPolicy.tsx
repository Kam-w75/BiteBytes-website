    ...
    <div className="pt-32 pb-24 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl">
        ...
        >
          ...
          <p className="text-slate-500 mb-12">Last updated: October 24, 2025</p>
          ...
          <div className="prose prose-slate max-w-none space-y-8 text-slate-600 leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li>Sync your data across devices via our Supabase backend.</li>
            ...
            <section>
              ...
              <p>We implement industry-standard security measures, including end-to-end encryption for data in transit and secure database storage via Supabase. Your recipe secrets are protected by multi-factor authentication requirements.</p>
            </section>
            ...
            <section>
              ...
              <ul className="list-disc pl-6 space-y-2 mt-4">
                ...
                <li><strong>RevenueCat:</strong> For managing iOS App Store subscriptions.</li>
